package com.dante.educhat.auth
...
import com.dante.educhat.R
import com.dante.educhat.general.HomeActivity
import com.dante.educhat.modals.StudentData
import com.dante.educhat.utils.AppPreferences
...
class StudentDetailsActivity : AppCompatActivity() {
    ...
    private var COLLEGE_NAME_GMRIT = Pair("Mukuba University", "MKU")

    private var CSE_DEPT = Pair("Education Computer Science ", "EdCSE")
    private var IT_DEPT = Pair("Education Agriculture science", "EdAgric")
    private var ECE_DEPT = Pair("Education Chemistry", "EdChem")
    private var EEE_DEPT = Pair("Education Physics","EdPhy")
    private var CIV_DEPT = Pair("Education Biology","EdBio")
    private var MECH_DEPT = Pair("Education Nutritional Science","EdNut")
    private var CHEM_DEPT = Pair("Education Geography","EdGeo")
    ...
    private var A_SECTION = Pair("Fulltime", "A")
    private var B_SECTION = Pair("ODL", "B")
    private var C_SECTION = Pair("Blended", "C")
